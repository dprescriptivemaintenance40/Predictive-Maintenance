...
@Component({
  selector: 'app-input-data-management',
  templateUrl: './input-data-management.component.html',
  styleUrls: ['./input-data-management.component.scss']
})
export class InputDataManagementComponent implements OnInit {
