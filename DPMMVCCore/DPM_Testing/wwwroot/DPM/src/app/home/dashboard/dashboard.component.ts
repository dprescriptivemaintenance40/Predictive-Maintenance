...
export class DashboardComponent {
  ...
  ALLGraphCBA (){
    ...
    this.changeDetectorRef.detectChanges();
      ...
      //   datasets: [
      //     {
      //      label: "Economic Risk without Maintenance",
      //       data: [economiccost],
      ...
      //     }, 
      //     {
      //       label:  'Economic Risk Without Constraint',
      //       data: [economiccostWithoutConstraint],
      ...
      //     }, 
      //     {
      //       label: 'Economic Risk with DPM with constraint',
      ...
      //     },
      //     {
      //       label: 'Residual Risk with DPM with constraint',
      ...
      //     },
      //     {
      //       label: 'MEI with DPM without constraint',
      //       data: [meicostWithoutConstraint],
      ...
      //     },
      //     {
      //       label: 'MEI with DPM with constraint',
