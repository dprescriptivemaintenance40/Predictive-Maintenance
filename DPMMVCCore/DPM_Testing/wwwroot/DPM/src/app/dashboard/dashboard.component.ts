...
export class DashboardComponent {
  ...
  // public CompressorTypeSelected: boolean = false;
  // public RemoveCompressorTypeDisable: boolean = true;
  // public DateSelected: boolean = false;
  // public RemoveDateDisable: boolean = true;
  ...
  SelectCompressorType() {
    if (this.CompressorType == 'ScrewCompressor') {
      ...
      // this.CompressorTypeSelected = true;
      // this.RemoveCompressorTypeDisable = false;
      // this.DateSelected = false;
      // this.RemoveDateDisable = true;
     // this.messageService.add({ severity: 'info', summary: 'Info', detail: 'Now Select Train or Prediction Type', sticky: true });
      ...
      // this.CompressorTypeSelected = false;
      // this.RemoveCompressorTypeDisable = true;
      // this.DateSelected = false;
      // this.RemoveDateDisable = true;
    }
  }
  ...
  TrainPredict() {
    if (this.SelectDateType.length > 0) {
      ...
      // this.RemoveDateDisable = false;
     // this.messageService.add({ severity: 'info', summary: 'Info', detail: 'Now Select Date Please', sticky: true });
    ...
    this.http.get<any>(this.url).subscribe(
      res => {
        ...
        if (this.ScrewTrainDateList.length > 0) {
          ...
          //this.messageService.add({ severity: 'info', summary: 'Info', detail: 'Now data to show chart, upload records in train and Predicton to plot grph', sticky: true });
          this.commonLoadingDirective.showLoading(false, "No records to plot graph....");
